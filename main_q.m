...
qAgent3.AgentOptions.EpsilonGreedyExploration.Epsilon = 0.9;
...
qAgent3.AgentOptions.CriticOptimizerOptions.LearnRate = 0.3;
qAgent.AgentOptions.DiscountFactor = 0.8;
%% Training Agent
...
min_reward_test = -10;
max_reward_test = -1;
step_penalty_test = -0.1;  
terminal_reward_test = 50; 
...
%%
figure;
plot(tot_reward(1:60));
xlabel('Episodes');
ylabel('Episode Reward');
title('Episode Reward vs Episodes');
...
num_simulations = 1; 
simulation_times = zeros(1, num_simulations); 
